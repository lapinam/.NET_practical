...
namespace LawyerTask
{
    class District
    {
        ...
        public District(string name, string city, int districtID)
        {
            this.title = name;
            this.city = city;
        ...
        {
            string stringValue = "District name : " + this.Title + " ; " + "City : " + this.city + " ; " + "District ID : " + this.districtID + " ; " +
        ...
        public static void CompareDistricts(District district1, District district2)
        {
            ...
            if (avrgDist1 > avrgDist2)
                Console.WriteLine(district1.Title + ">" + district2.Title);
